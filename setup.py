...
setup(
    ...
    description="Read the position of players from a MarioKart screenshot and write the results to a Excel file",  # Optional
    ...
    # above.
    author_email="max.perraudin@gmail.com",  # Optional
    ...
    install_requires=["Click", "opencv-python", "openpyxl", "easyocr", "tqdm"],  # Optional
